...
<form role="form" method="POST" action="{{url('products/'.$data->id)}}">
    ...
    <div class="form-body">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="product_name" required value="{{$data->name}}">
        </div>
        <div class="form-group">
            <label for="exampleInputEmail1">Harga Produk Obat</label>
            <input type="text" class="form-control" name="product_price" required value="{{$data->product_price}}">
        </div>
        <div class="form-group">
